...
var page = {
	...
	showDetailDialog: function(m) {
		...
		$('#participanteDetailDialog').modal({ show: true });
	...
	updateModel: function() {
		...
		page.participante.save({
			...
			success: function(){
				...
				setTimeout("app.appendAlert('Participante was sucessfully " + (isNew ? "inserted" : "updated") + "','alert-success',3000,'collectionAlert')",500);
				app.hideProgress('modelLoader');
