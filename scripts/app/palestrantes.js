...
var page = {
	...
	showDetailDialog: function(m) {
		...
		$('#palestranteDetailDialog').modal({ show: true });
	...
	updateModel: function() {
		...
		page.palestrante.save({
			...
			success: function(){
				...
				setTimeout("app.appendAlert('Palestrante was sucessfully " + (isNew ? "inserted" : "updated") + "','alert-success',3000,'collectionAlert')",500);
				app.hideProgress('modelLoader');
