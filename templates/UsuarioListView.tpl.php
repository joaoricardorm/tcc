<?php
	$this->assign('title','Certificados FAROL | Usuarios');
		...
		<form class="form-horizontal" onsubmit="return false;">
			<fieldset>
				...
				<div id="tipoUsuarioInputContainer" class="control-group">
					...
					<div class="controls inline-inputs">
						<input type="text" class="input-xlarge" id="tipoUsuario" placeholder="Tipo Usuario" value="<%= _.escape(item.get('tipoUsuario') || '') %>">
						<span class="help-inline"></span>
					</div>
				</div>
			</fieldset>
