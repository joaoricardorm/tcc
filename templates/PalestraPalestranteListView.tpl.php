...
<h1>
		...
		<form id="deletePalestraPalestranteButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deletePalestraPalestranteButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete PalestraPalestrante</button>
						<span id="confirmDeletePalestraPalestranteContainer" class="hide">
							<button id="cancelDeletePalestraPalestranteButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeletePalestraPalestranteButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="palestraPalestranteDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit PalestraPalestrante
		...
		<div class="modal-footer">
			...
			<button id="savePalestraPalestranteButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newPalestraPalestranteButton" class="btn btn-primary">Add PalestraPalestrante</button>
	</p>
