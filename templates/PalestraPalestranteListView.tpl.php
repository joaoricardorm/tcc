<?php
	$this->assign('title','Palestra Palestrantes Associação - Certifica-µ');
...
<script type="text/javascript">
	$LAB.script(base+"scripts/app/palestrapalestrantes.js").wait(function(){
...
<h1>
	...
	<div class="modal hide fade animated bounceIn modal-on-top"  data-backdrop="static" id="palestraPalestranteDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i id="icone-acao-modal" class="icon-edit"></i> <span id="titulo-modal">Editar</span> PalestraPalestrante
