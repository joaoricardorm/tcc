...
-->
		...
		<form id="deletePalestranteButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deletePalestranteButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete Palestrante</button>
						<span id="confirmDeletePalestranteContainer" class="hide">
							<button id="cancelDeletePalestranteButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeletePalestranteButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="palestranteDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit Palestrante
		...
		<div class="modal-footer">
			...
			<button id="savePalestranteButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newPalestranteButton" class="btn btn-primary">Add Palestrante</button>
	</p>
