<?php
	$this->assign('title','Palestra Participantes Associação - Certifica-µ');
...
<h1>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade animated bounceIn modal-on-top"  data-backdrop="static" id="palestraParticipanteDetailDialog">
