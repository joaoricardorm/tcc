...
<h1>
		...
		<form id="deletePalestraParticipanteButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<button id="deletePalestraParticipanteButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete PalestraParticipante</button>
						<span id="confirmDeletePalestraParticipanteContainer" class="hide">
							<button id="cancelDeletePalestraParticipanteButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeletePalestraParticipanteButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="palestraParticipanteDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Edit PalestraParticipante
		...
		<div class="modal-footer">
			...
			<button id="savePalestraParticipanteButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newPalestraParticipanteButton" class="btn btn-primary">Add PalestraParticipante</button>
	</p>
