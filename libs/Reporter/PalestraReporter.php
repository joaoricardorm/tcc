...
/**
 * This is an example Reporter based on the Palestra object.  The reporter object
 ...
 * @version 1.0
 */
class PalestraReporter extends Reporter
{
	...
	*/
	static function GetCustomQuery($criteria)
	{
		$sql = "select
			...
			,`palestra`.`carga_horaria` as CargaHoraria
	...
	*/
	...
	{
		$sql = "select count(1) as counter from `palestra`";
