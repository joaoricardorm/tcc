...
class UsuarioController extends AppBaseController 
{
	...
	{
		/*$this->RequirePermission(Usuario::$PERMISSION_USER, 
				'Usuario.LoginForm', 
				'Login is required to access the secure user page',
				'You do not have permission to access the secure user page');*/
		
		//$this->RequerPermissao('admin');
		
		echo 'Fulera:' . $this->GetCurrentUser()->Nome;
	...
	public function AdminPage()
	{
		...
		echo 'Admin: '. $this->GetCurrentUser()->Nome;
	...
	public function Logout()
	{
		...
		$this->Redirect("Usuario.LoginForm","You are now logged out");
	}  **/
