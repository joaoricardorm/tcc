...
require_once("DAO/CertificadoCriteriaDAO.php");

/**
 * The CertificadoCriteria class extends CertificadoDAOCriteria and is used
 ...
 * @version 1.0
 */
class CertificadoCriteria extends CertificadoCriteriaDAO
{
