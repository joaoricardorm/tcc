...
require_once("DAO/PalestraCriteriaDAO.php");

/**
 * The PalestraCriteria class extends PalestraDAOCriteria and is used
 ...
 * @version 1.0
 */
class PalestraCriteria extends PalestraCriteriaDAO
{
