...
require_once("DAO/ConfiguracaoCriteriaDAO.php");

/**
 * The ConfiguracaoCriteria class extends ConfiguracaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConfiguracaoCriteria extends ConfiguracaoCriteriaDAO
{
